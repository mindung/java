...
public class ChartFrame4 extends BaseFrame{
	...
	class Chart extends JPanel{
		...
		public void paint(Graphics g) {
			...
			for (int i = 0; i < 7; i++) {
				...
				g.drawString(String.valueOf(num), 40, 90 +  (i * 80));
				g.drawString(String.valueOf(2010 + i), 60 + (i * 200), 600);
				num -= 2;
			}
	...
	public static void main(String[] args) {
		new ChartFrame4().setVisible(true);
	}
}
